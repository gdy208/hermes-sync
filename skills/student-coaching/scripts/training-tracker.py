#!/usr/bin/env python3
"""Lecture de l'etat d'avancement pour cron matinal adaptatif.
Inclut suivi des revisions (probas/analyse/algebre)."""
...
math_next_info = math_rotation.get(math_info["next"], math_rotation["probas"])
